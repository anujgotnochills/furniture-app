...
const CATEGORIES: Category[] = [
  {
    ...
    icon: 'face-man',
    children: [
      { id: '1-1', name: 'T-Shirts', icon: 'dry-cleaning' },
      { id: '1-2', name: 'Shirts', icon: 'dry-cleaning' },
      { id: '1-3', name: 'Jeans', icon: 'dry-cleaning' },
      { id: '1-4', name: 'Jackets', icon: 'dry-cleaning' },
    ],
  },
  {
    id: '2',
    ...
    icon: 'face-woman',
    children: [
      { id: '2-1', name: 'Dresses', icon: 'dry-cleaning' },
      { id: '2-2', name: 'Tops', icon: 'dry-cleaning' },
      { id: '2-3', name: 'Skirts', icon: 'dry-cleaning' },
    ],
  },
  {
    id: '3',
    ...
    children: [
      { id: '3-1', name: 'Sneakers', icon: 'sports-basketball' },
      { id: '3-2', name: 'Boots', icon: 'sports-basketball' },
      { id: '3-3', name: 'Sandals', icon: 'sports-basketball' },
    ],
  },
  {
    id: '4',
    ...
    icon: 'watch',
    children: [
      { id: '4-1', name: 'Bags', icon: 'work-outline' },
      { id: '4-2', name: 'Watches', icon: 'watch' },
      { id: '4-3', name: 'Jewelry', icon: 'star-outline' },
    ],
  },
];
